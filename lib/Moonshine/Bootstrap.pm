...
BEGIN {
    ...
    my %modifier_spec = (
        (
            map { $_ => 0 }
              qw/row switch lead txt switch_base class_base sizing sizing_base alignment alignment_base active disable justified justified_base container/
        ),
        (
    ...
    my @lazy_components = qw/li a th td tr p div span b i u dl dd dt h1 h2 h3 h4 h5 h6 ol label form small mark del s ins em strong address blockquote footer cite code kbd pre var/;
